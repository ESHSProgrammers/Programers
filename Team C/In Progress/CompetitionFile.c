...
#pragma config(Sensor, I2C_3,  FLEncode,       sensorQuadEncoderOnI2CPort,    , AutoAssign )
#pragma config(Motor,  port2,           FR,            tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           BR,            tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           FL,            tmotorVex393_MC29, PIDControl, encoderPort, I2C_3)
...
//FOR LEFT STARTING POSITION
{
	while (true)
	{
		...
		SensorValue[FLEncode] = 0;

		while(SensorValue[FLEncode] < 120)
		{
		motor[FR] = 127;
		motor[BR] = 127;
		motor[FL] = 127;
    ...
    motor[FR] = 0;
		...
		//puts starter cone on top of mobile goal
		...
		//move along white line until perpendicualr to goal
		while(SensorValue[FLEncode] < 150)
		{
		motor[FR] = 127;
		motor[BR] = 127;
		motor[FL] = 127;
    ...
    motor[FR] = 127;
		...
		//drive into goal zones
		while(SensorValue[FLEncode] < 200)
		{
		motor[FR] = 127;
		motor[BR] = 127;
		motor[FL] = 127;
