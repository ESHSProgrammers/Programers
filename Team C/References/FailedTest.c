...
#pragma config(Sensor, I2C_1,  leftBse,        sensorQuadEncoderOnI2CPort,    , AutoAssign )
#pragma config(Sensor, I2C_2,  rightBase,      sensorQuadEncoderOnI2CPort,    , AutoAssign )
#pragma config(Sensor, I2C_3,  Lift,           sensorQuadEncoderOnI2CPort,    , AutoAssign )
#pragma config(Motor,  port2,           FR,            tmotorVex393_MC29, openLoop, encoderPort, I2C_2)
#pragma config(Motor,  port3,           BR,            tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           FL,            tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
#pragma config(Motor,  port5,           BL,            tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port6,           LLift,         tmotorVex393_MC29, openLoop, encoderPort, None)
#pragma config(Motor,  port7,           RLift,         tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_3)
...
displayLCDCenteredString(0,"Lift Value");
	float ldec = SensorValue[Lift];
	displayLCDNumber(1,1,ldec,2);
	if (nLCDButtons == 2)
	{
		SensorValue[leftBase] = 0;
