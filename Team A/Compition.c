...
#pragma config(Sensor, I2C_5,  LL2,            sensorQuadEncoderOnI2CPort,    , AutoAssign )
#pragma config(Sensor, I2C_6,  CL,             sensorQuadEncoderOnI2CPort,    , AutoAssign )
...
#pragma config(Motor,  port4,           CL,            tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_6)
...
#pragma config(Motor,  port7,           LL2,           tmotorVex393_MC29, openLoop, encoderPort, I2C_5)
...
#pragma config(Motor,  port10,          RL2,           tmotorVex393_HBridge, openLoop)
...
SensorValue[Cl]=0;
	...
	wait10Msec(50);
	motor[cl]=0;
while (abs (SensorValue[LL2])<1600)
{
	motor[LL2]=-127;
	Motor[Rl2]=-127;
}
...
while(sensorValue[LeftLift]> -900)
{
	motor[RL]=127;
	motor[LL]=-127;
...
void DisplayClaw()
{
	displayLCDCenteredString(0," Claw");
	displayLCDNumber(1,1,SensorValue[CL],5);
	if (nLCDButtons == 2)
	{
		SensorValue[CL] = 0;}}
////////////////////////////////////////////////////[ColorSensorValue]
